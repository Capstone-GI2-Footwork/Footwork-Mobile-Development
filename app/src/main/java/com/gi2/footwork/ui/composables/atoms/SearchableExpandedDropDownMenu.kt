 ...
 * @param shape the shape of the TextField's background. Default is [MaterialTheme.shapes.small]
 ...
 * @param onSearchQueryChanged use this if you want data to refresh from the server
 */
...
fun <T> SearchableExpandedDropDownMenu(
  ...
  if (showDefaultSelectedItem) {
    selectedOptionText =
      selectedOptionText.ifEmpty { listOfItems[defaultItemIndex].toString() }
        ...
        Column(
          ...
          OutlinedTextField(
            ...
            onValueChange = { selectedSport ->
              ...
              onSearchQueryChanged(searchedOption)
            },
            leadingIcon = {
              Icon(
